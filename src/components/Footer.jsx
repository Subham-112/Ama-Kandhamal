...
const Footer = () => {
  return (
    <footer className="bg-dark-gray text-white pt-10 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info - Full width on mobile, spans 2 columns on desktop */}
          <div className="lg:col-span-2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <img src="/logo.png" alt="AMA KANDHAMAL" className='h-auto mb-5' style={{ width: "200px" }} />
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-center lg:justify-start">
                <Mail className="h-5 w-5 text-primary-green mr-3 flex-shrink-0" />
                <span className="text-gray-300 text-sm">support@amakandhamal.com</span>
              </div>
              <div className="flex items-center justify-center lg:justify-start">
                <Phone className="h-5 w-5 text-primary-green mr-3 flex-shrink-0" />
                <span className="text-gray-300">+91 12345 67890</span>
              </div>
              <div className="flex items-start justify-center lg:justify-start">
                <MapPin className="h-5 w-5 text-primary-green mr-3 mt-1 flex-shrink-0" />
