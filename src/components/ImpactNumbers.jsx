...
const ImpactNumbers = () => {
  ...
  return (
    <section id="impact-numbers" className="py-10 lg:py-20 bg-light-green">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className={`text-center bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-500 ${
            isVisible 
              ? 'animate-fade-in-up opacity-100' 
              : 'opacity-0 translate-y-8'
          }`}
          style={{ animationDelay: '0.2s' }}>
            <div className="text-4xl md:text-4xl font-bold text-primary-green mb-3 animate-counter">
              {counts.orders.toLocaleString()}+
            </div>
            <div className="text-2xl font-semibold text-gray-900 mb-2">Daily Orders</div>
          ...
          style={{ animationDelay: '0.3s' }}>
            ...
            <div className="text-2xl font-semibold text-gray-900 mb-2">Happy Customers</div>
          ...
          style={{ animationDelay: '0.4s' }}>
            ...
            <div className="text-2xl font-semibold text-gray-900 mb-2">Reorder Rate</div>
